...
class DataPesertaTampilSelect extends StatefulWidget {
  final DataPesertaApiData data;
  const DataPesertaTampilSelect({super.key, required this.data});

  @override
  State<DataPesertaTampilSelect> createState() => _DataPesertaTampilSelectState();
}
