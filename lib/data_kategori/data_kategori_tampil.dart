...
class DataKategoriTampil extends StatefulWidget {
  final DataKategoriApiData data;
  final Function(DataKategoriApiData value) onTapEdit;
  final Function(DataKategoriApiData value) onTapHapus;

  const DataKategoriTampil({
    super.key,
    required this.data,
  ...
  @override
  State<DataKategoriTampil> createState() =>
      _DataKategoriTampilState();
}

class _DataKategoriTampilState extends State<DataKategoriTampil> {
  @override
