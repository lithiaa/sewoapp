...
class DataProdukTampil extends StatefulWidget {
  final DataProdukApiData data;
  final Function(DataProdukApiData value) onTapEdit;
  final Function(DataProdukApiData value) onTapHapus;

  const DataProdukTampil({
    super.key,
    required this.data,
  ...
  @override
  State<DataProdukTampil> createState() =>
      _DataProdukTampilState();
}

class _DataProdukTampilState extends State<DataProdukTampil> {
  @override
