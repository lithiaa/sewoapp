...
class DataPemesananTambahScreen extends StatefulWidget {
  static const routeName = "data_pemesanan/tambah";
  const DataPemesananTambahScreen({super.key});

  @override
  State<DataPemesananTambahScreen> createState() =>
      _DataPemesananTambahScreenState();
}

class _DataPemesananTambahScreenState extends State<DataPemesananTambahScreen> {
  ...
  Widget build(BuildContext context) {
    var args = ModalRoute.of(context)!.settings.arguments
        as DataPemesananTambahArguments;
    ...
    return BlocListener(
      bloc: BlocProvider.of<DataPemesananSimpanBloc>(context),
      ...
      child: BlocBuilder<DataPemesananSimpanBloc, DataPemesananSimpanState>(
                    ...
                    child: Column(
                      children: [
                        ...
                        ElevatedButton(
                          ...
                          onPressed: () {
                            BlocProvider.of<DataPemesananSimpanBloc>(context)
                                .add(FetchDataPemesananSimpan(form));
                          },
                          child: state is DataPemesananSimpanLoading
...
class DataPemesananTambahArguments {
  final DataPemesanan data;
  final String judul;

  DataPemesananTambahArguments({
    required this.data,
    required this.judul,
  });
}
